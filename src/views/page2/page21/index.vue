    ...
    <el-row :gutter="20">
      <el-col :span="14" class="left">
        <div class="echarts-box">
          <div class="tools">
            <div class="time">更新时间：{{ nowTime1 }}</div>
        ...
        <div class="echarts-box">
          <div class="tools">
            <div class="time">更新时间：{{ nowTime2 }}</div>
  ...
  methods: {
    ...
    async getEchartOptions1(data) {
      try {
        ...
        let markLineData = [];
        markLineData.push({
          xAxis: this.nowTime1.slice(0, 13) + ":00:00",
        });
        seriesData.push({
          type: "line",
          markLine: {
    ...
    async getEchartOptions2(data) {
      try {
        ...
        let markLineData = [];
        markLineData.push({
          xAxis: this.nowTime2.slice(0, 13) + ":00:00",
        });
        seriesData.push({
          type: "line",
          markLine: {
