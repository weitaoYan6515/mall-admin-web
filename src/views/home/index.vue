    ...
    <el-row :gutter="20">
      <el-col :span="14" class="left">
        <div class="echarts-box">
          <div class="tools">
            <my-time-select @change="change1"></my-time-select>
          </div>
          <div class="echarts">
        ...
        <div class="echarts-box">
          <div class="tools">
            <my-time-select @change="change2"></my-time-select>
          </div>
          <div class="echarts">
        ...
        <div class="echarts-box">
          <div class="tools">
            <my-time-select @change="change3"></my-time-select>
          </div>
          <div class="echarts">
...
export default {
  ...
  methods: {
    ...
    async getEcharts() {
      try {
        ...
        let seriesData2 = [];
        let seriesData3 = [];
        let legendData = [this.getName("totalLoad")];
        data.type.map((item) => {
          legendData.push(this.getName(item));
        });
        let stove_a = [],
        ...
        this.tableData.map((item) => {
          ...
          totalLoad.push([
            item.nextRenewTime,
            Number(item.stoveA) + Number(item.stoveB) + 10,
          ]);
        });
        seriesData1.push({
  ...
  async mounted() {
    ...
    this.$eventBus.$off("changeTableDataConfirm");
    this.$eventBus.$off("changeTableDataCancel");
    this.$eventBus.$off("changeTableDataBlur");
    this.$eventBus.$on("changeTableDataConfirm", async () => {
      await this.getTableList();
      await this.getEcharts();
    ...
    this.$eventBus.$on("changeTableDataCancel", async () => {
      await this.getTableList();
      await this.getEcharts();
    });
    this.$eventBus.$on("changeTableDataBlur", async () => {
      await this.getEcharts();
    });
